...
$langHelpPowerUser = "Ο βοηθός διαχειριστή διαχειρίζεται τα μαθήματα και τους χρήστες";
...
$langSpeeSubscribe = "Εγγραφή ως Διαχειριστής Μαθήματος";
...
$langCourseDelConfirm2 = "Θέλετε σίγουρα να διαγράψετε το μάθημα";
...
$langAuthNoValidUser = "Τα στοιχεία που δώσατε δεν είναι σωστά. Η εγγραφή δεν πραγματοποιήθηκε.";
...
$langThe = "Η ";
$langActFailure = "δεν μπορεί να ενεργοποιηθεί διότι δεν έχετε καθορίσει τις ρυθμίσεις του";
$langLdapNotWork = "Προειδοποίηση: Η php δεν έχει υποστήριξη για ldap. Βεβαιωθείτε ότι η ldap υποστήριξη είναι εγκατεστημένη και ενεργοποιημένη.";
...
$langErrorUnreguser = "Σφάλμα κατά την απεγγραφή του χρήστη από μάθημα";
$langAfter = "Μετά από";
$langBefore = "Πριν από";
...
$langDocQuota = "Όριο αποθηκευτικού χώρου μαθήματος για τα «Έγγραφα»";
$langVideoQuota = "Όριο αποθηκευτικού χώρου μαθήματος για τα «Βίντεο»";
$langDropboxQuota = "Όριο αποθηκευτικού χώρου μαθήματος για την «Ανταλλαγή μηνυμάτων»";
...
$langConfirmEnableIndex = "Η ευρετηριοποίηση θα χρειαστεί <strong>συγκεκριμένο χρονικό διάστημα και υπολογιστικούς πόρους</strong> για να πραγματοποιηθεί, ανάλογα με το μέγεθος της βάσης δεδομένων.<br/><br/>Η διαδικασία θα ξεκινήσει σε <u>ξεχωριστό παράθυρο</u> μετά την αποθήκευση των ρυθμίσεων.<br/><br/>Επίσης, η ευρετηριοποίηση <u>δεν</u> είναι διαθέσιμη στην περίπτωση εγκατάστασης της πλατφόρμας σε <u>NFS filesystem</u>.<br/><br/><em>Ακυρώστε</em> την επιλογή σας αν επιθυμείτε να ξεκινήσετε την ευρετηριοποίηση σε <u>άλλη</u> χρονική στιγμή.";
...
$langIndexingRemain = "Μαθήματα που απομένουν για ευρετηριοποίηση";
$langIndexingDone = "Η ευρετηροποίηση ολοκληρώθηκε επιτυχώς, μπορείτε να κλείσετε αυτό το παράθυρο.";
...
$langInvalidMail = "έχουν άκυρη διεύθυνση email ή δεν έχουν καθόλου";
...
$langInfoUnsubscribe = "Μπορείτε να ρυθμίσετε τη λήψη ειδοποιήσεων από τα παρακάτω μαθήματα. Αν δεν επιθυμείτε
...
$langAuthChangeno = "Δεν υπάρχει άλλος ενεργοποιημένος τρόπος πιστοποίησης";
$langAuthChangeYes = "Επιτυχής αλλαγή πιστοποίησης";
...
Το περιεχόμενο των ηλεκτρονικών μαθημάτων που φιλοξενεί η πλατφόρμα ' . $siteName . ', καθώς και τα πνευματικά δικαιώματα του υλικού αυτού, ανήκουν στους συγγραφείς τους και το GUnet δεν διεκδικεί δικαιώματα σε αυτό. Για οποιαδήποτε χρήση ή αναδημοσίευση του περιεχομένου παρακαλούμε επικοινωνήστε με τους υπεύθυνους των αντίστοιχων μαθημάτων.
';
...
$langByDel = "Διαγράφοντας το μάθημα θα διαγράψετε μόνιμα όλα τα περιεχόμενά του και όλους τους " . $langsStudents . " που είναι γραμμένοι σε αυτό (δεν θα διαγραφούν από τα άλλα μαθήματα).";
...
$langDivision = "Τομέας";
$langTargetFac = "Η $langsFaculty στην οποία υπάγεται το μάθημα";
$langDoubt = "Αν δεν ξέρετε το κωδικό του μαθήματος συμβουλευτείτε";
$langExFac = "* Αν επιθυμείτε να δημιουργήσετε μάθημα σε άλλη $langsFaculty από αυτή που ανήκετε, τότε επικοινωνήστε με
...
$langMultiCourse = 'Μαζική δημιουργία μαθημάτων';
$langMultiCourseInfo = 'Εισαγάγετε στην παρακάτω περιοχή μια λίστα με τους
τίτλους των μαθημάτων που επιθυμείτε να δημιουργηθούν, με τον κάθε
τίτλο σε ξεχωριστή γραμμή. Αν επιθυμείτε να προστεθεί αυτόματα
καθηγητής στο μάθημα, σημπληρώστε το ονοματεπώνυμο ή το όνομα χρήστη
...
$langlastUpdated = "Τελευταία ενημέρωση την";
...
$langMailToUsers = "Να ειδοποιηθούν οι χρήστες";
$langDropboxMailNotify = "σας έχει αποσταλλεί ένα καινούριο μήνυμα. Θα το βρείτε στο υποσύστημα 'Ανταλλαγή Μηνυμάτων' αφού προηγουμένως κάνετε login στην πλατφόρμα ή κάνοντας κλικ στο παρακάτω σύνδεσμο:";
$langNewDropboxFile = "Ενημέρωση για καινούριο μήνυμα";
...
$langMessageDeleteAllSuccess = "Η διαγραφή των μηνυμάτων πραγματοποιήθηκε επιτυχώς!";
$langMsgRe = "Απ:";
...
$langQuestionNotDefined = "Μη προσδιορισμένος";
...
$langNodeAllowCourse = "Εγγραφή μαθημάτων";
$langNodeAllowCourse2 = "(έλεγχος αν θα μπορούν να ανήκουν μαθήματα στη σχολή - τμήμα)";
...
$langNodeProErase = "Υπάρχουν μαθήματα ή χρήστες που ανήκουν σε αυτόν τον κόμβο (σχολή/τμήμα) ή στα παιδιά του!";
...
$langOkSent = "<b>Η σελίδα σας στάλθηκε</b><br/>Δημιουργήθηκε σύνδεσμος προς αυτήν στο αριστερό μενού";
...
$langListCourses = "Κατάλογος Μαθημάτων";
...
$langWelcomeStudPerso = "«<b>$langListCourses</b>» για να παρακολουθήσετε τα διαθέσιμα ηλεκτρονικά μαθήματα.";
...
$langInstallBullet1 = "Μια βάση δεδομένων MySQL, στην οποία υπάρχει χρήστης με δικαιώματα να δημιουργεί και να διαγράφει βάσεις δεδομένων.";
...
$langErrorConfig = "<b>Παρουσιάστηκε σφάλμα!</b><br><br>Δεν είναι δυνατή η δημιουργία του αρχείου config.php.<br><br>Παρακαλούμε ελέγξτε τα δικαιώματα πρόσβασης στους υποκαταλόγους του Open eClass και δοκιμάστε ξανά την εγκατάσταση.";
$langErrorConfigAlt = "Εναλλακτικά, μπορείτε να δημιουργήσετε απευθείας το αρχείο <b>config.php</b> στον υποκατάλογο <b>%s</b> με τα παρακάτω περιεχόμενα:";
...
$langWillWrite = "Τα παρακάτω θα γραφτούν στο αρχείο <b>config/config.php</b>.";
...
$langExerciseDone = "Η άσκηση ολοκληρώθηκε. Για να συνεχίσετε, μπορείτε να επιλέξετε την επόμενη ενότητα, κάνοντας κλικ στο επόμενο βήμα.";
...
$langInsertMyDescToolName = "Εισαγωγή πληροφοριών μαθήματος";
...
$langLinkAlreadyUsed = "Αυτός ο σύνδεσμος ήδη χρησιμοποιείται ως ενότητα σε αυτήν τη γραμμή μάθησης";
...
$langMediaInsertedAsModule = "Έχει προστεθεί ως ενότητα μαθήματος αυτής της γραμμής μάθησης";
...
$langAccountNotFound1 = "Δε βρέθηκε λογαριασμός στην πλατφόρμα με τα στοιχεία που δώσατε.";
$langAccountNotFound2 = "Αν παρ' όλα αυτά είστε σίγουρος/η ότι έχετε ήδη λογαριασμό, παρακαλούμε επικοινωνήστε με τους διαχειριστές της πλατφόρμας στη διεύθυνση ";
...
$langPassCannotChange2 = "Ο λογαριασμός αυτός πιστοποιείται ";
...
κάνοντας κλικ";
$m['here'] = " εδώ.";
$m['unsub'] = 'Το μάθημα είναι κλειστό και δεν θα μπορέσετε να επανεγγραφείτε.';
...
$langPersonalSettingsMore = "Κάντε κλίκ <a href='../../index.php'>εδώ</a> για να εισέλθετε στο προσωπικό σας χαρτοφυλάκιο.<br>
                Εκεί μπορείτε:<ul><li>να περιηγηθείτε στο περιβάλλον της πλατφόρμας και τις προσωπικές σας επιλογές,</li>
                <li>να επιλέξετε από τον 'Κατάλογο Μαθημάτων' τα μαθήματα που επιθυμείτε να παρακολουθήσετε.</li><ul>";
...
$langMailVerificationNotice = "Εάν είναι υποχρεωτική η επιβεβαίωση του e-mail του $langOfUser
                ...
                <li>ο χρήστης δεν θα λαμβάνει e-mail με ανακοινώσεις από τα μαθήματα που παρακολουθεί</li></ul>";
...
$langInfo2 = "Μπορείτε να αλλάξετε τον κωδικό του μαθήματος και ό,τι άλλο θέλετε (π.χ. περιγραφή, καθηγητής κ.λπ.)";
...
$langKeywords_Descr = "μία ή περισσότερες λέξεις κλειδιά που προσδιορίζουν τη θεματική περιοχή του μαθήματος";
...
$langUpgSucNotice = "Αν παρουσιάστηκε κάποιο σφάλμα, πιθανόν κάποιο μάθημα να μην δουλεύει εντελώς σωστά.<br>
                ...
                περιγράφοντας το πρόβλημα που παρουσιάστηκε και στέλνοντας (αν είναι δυνατόν) όλα τα μηνύματα που εμφανίστηκαν στην οθόνη σας";
...
$langLoginRequired = '
        ...
        <br>Η πλατφόρμα σάς ανακατεύθυνε αυτόματα στην αρχική σελίδα
        για να εγγραφείτε στο μάθημα, αν η εγγραφή είναι ελεύθερη.';
$langSessionIsLost = "
        <b>Η σύνοδος σας έχει λήξει.</b>
        <br>Η πλατφόρμα σάς ανακατεύθυνε αυτόματα στην αρχική σελίδα
        για να συνδεθείτε προτού προχωρήσετε σε άλλες ενέργειες.";
$langCheckProf = "
        <b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα καθηγητή.</b>
        <br>Η πλατφόρμα σάς ανακατεύθυνε αυτόματα στην αρχική σελίδα
        για να συνδεθείτε ξανά.";
$langCheckCourseAdmin = "
        <b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα διαχειριστή μαθήματος.</b>
        <br>Η πλατφόρμα σάς ανακατεύθυνε αυτόματα στην αρχική σελίδα
        για να συνδεθείτε ξανά.";
$langLessonDoesNotExist = "
	<b>Το μάθημα που προσπαθήσατε να προσπελάσετε δεν υπάρχει.</b>
	<br>Αυτό μπορεί να συμβαίνει γιατί εκτελέσατε μια μη επιτρεπτή ενέργεια ή λόγω τεχνικού προβλήματος
	στην πλατφόρμα.</p>";
$langCheckAdmin = "
        <b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα διαχειριστή.</b>
        <br>Η πλατφόρμα σάς ανακατεύθυνε αυτόματα στην αρχική σελίδα
...
$langCheckUserManageUser = "<b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα διαχειριστή χρηστών.</b>
        <br>Η πλατφόρμα σάς ανακατεύθυνε αυτόματα στην αρχική σελίδα
        για να συνδεθείτε ξανά.";
$langCheckDepartmentManageUser = "<b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα διαχειριστή τμημάτων.</b>
        <br>Η πλατφόρμα σάς ανακατεύθυνε αυτόματα στην αρχική σελίδα
        για να συνδεθείτε ξανά.";
$langCheckGuest = "
...
$langSubmit = "Υποβολή";
$langTestWork = "Εργαλείο Αυτοαξιολόγησης";
$langCheck = "Έλεγχος";
...
$langCourseActions = "Ενέργειες μαθήματος";
$langSystemActions = "Ενέργειες πλατφόρμας";
...
$m['WorkToAllUsers'] = 'Σε όλους τους Εκπαιδευόμενους';
$m['WorkToUser'] = 'Συγκεκριμένους Εκπαιδευόμενους';
...
$m['WorkUserGroupNoSubmission'] = 'Χρήστες/ομάδες χωρίς υποβολή';
$m['WorkGroupNoSubmission'] = 'Ομάδες χρηστών που δεν έχουν υποβάλει εργασία';
$m['NoneWorkGroupNoSubmission'] = 'Δεν υπάρχουν ομάδες χρηστών που δεν έχουν υποβάλει εργασία';
...
$m['work_email_message'] = 'Το παρακάτω μήνυμα αναφέρεται στην υποβολή σας στην εργασία με τίτλο «%s» του μαθήματος «%s»:';
...
$langNotice_test_work = "Δημιουργείστε Σενάρια Αυτοαξιολόγησης και ανεβάστε το αρχείο κώδικα ώστε να γίνει η αξιολόγησή του.";
...
$langMailVerifyNoApplication = "Δεν βρέθηκε η αίτησή σας. Παρακαλούμε επαναλάβετε από την αρχή την διαδικασία.";
...
$langNoEBook = 'Δεν υπάρχουν ηλεκτρονικά βιβλία διαθέσιμα στο μάθημα αυτό.';
$langLeave = 'Έξοδος';
...
$langBBBNoteEnableJoin = "Ο σύνδεσμος είναι ενεργός μόνο για όσες τηλεδιασκέψεις είναι σε εξέλιξη";
...
$langBBBNoServerForRecording = "Η ενεργοποίηση της τηλεδιάσκεψης δεν μπορεί να πραγματοποιηθεί καθώς δεν υπάρχει διαθέσιμος εξυπηρετητής BigBlueButton με ενεργοποιημένη τη δυνατότητα καταγραφής.<br />Παρακαλούμε είτε απενεργοποιήστε την επιλογή καταγραφής για να συνεχίσετε άμεσα είτε επικοινωνήστε με τον διαχειριστή της πλατφόρμας.";

$langΒΒΒAlertTitle = "Παρακαλώ πληκτρολογείστε τον τίτλο της τηλεδιάσκεψης";
$langΒΒΒAlertMaxParticipants = "Παρακαλώ ορίστε το μέγιστο πλήθος συμμετεχόντων";
$langΒΒΒServerAlertHostname = "Παρακαλώ πληκτρολογείστε το hostname του εξυπηρετητή";
$langΒΒΒServerAlertIP = "Παρακαλώ πληκτρολογείστε σωστά την ip του εξυπηρετητή";
$langΒΒΒServerAlertKey = "Παρακαλώ πληκτρολογείστε το διαμοιραζόμενο κλειδί του εξυπηρετητή";
$langΒΒΒServerAlertAPIUrl = "Παρακαλώ πληκτρολογείστε το ΑPI url του εξυπηρετητή";
$langΒΒΒServerAlertMaxRooms = "Παρακαλώ πληκτρολογείστε σωστά το μέγιστο πλήθος δωματίων του εξυπηρετητή";
$langΒΒΒServerAlertMaxUsers = "Παρακαλώ πληκτρολογείστε σωστά το μέγιστο πλήθος συνδεδεμένων χρηστών του εξυπηρετητή";
$langΒΒΒServerAlertOrder = "Παρακαλώ πληκτρολογείστε σωστά τη σειρά επιλογής του εξυπηρετητή";

$langBBBMaxUsersJoinError = "Έχει συμπληρωθεί ο μέγιστος αριθμός συμμετεχόντων στην τηλεδιάσκεψη. Παρακαλώ δοκιμάστε να συνδεθείτε αργότερα ή επικοινωνήστε με τον καθηγητή του μαθήματος";
/* * ***********************************************************
 * blog.php
 * ************************************************************ */
$langBlog = "Ιστολόγιο";
